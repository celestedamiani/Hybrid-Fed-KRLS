function [D_recon, dist] = OptSpace(M_E,r,niter,tol)
%function [X, S, Y, dist] = originalOptSpace(M_E,r,niter,tol)
...
% [D_recon, dist] = OptSpace(A,r,niter,tol);
% [D_recon, dist] = OptSpace(A);
% INPUT :
...
%
% OUTPUT :
% D_recon  : A size(A,1)xsize(A,2) matrix reconstruction
...
elseif(nargin==4)
	...
	fprintf(1,'Usage :\n[D_recon, dist] = OptSpace(A,r,niter,tol) \n') ;
	fprintf(1,'[D_recon, dist] = OptSpace(A)\n');
	return;
end	
